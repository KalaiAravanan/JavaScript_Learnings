...
//As a QA engineer, classify bugs based on two factors: frequency ("always", "often", "rarely") and 
// impact ("blocker", "major", "minor"). Write a JavaScript program using nested if-else that prints the bug severity level.
...
let frequency = "always"; // Change this value to test different frequencies        
let impact = "blocker"; // Change this value to test different impacts
